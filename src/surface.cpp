...
static void xdg_surface_configure(void* data, xdg_surface* xdg_surface,
    ...
    if (!popupSurface.eglWindow) {
        ...
        wl_egl_window_resize(popupSurface.eglWindow, popupSurface.width,
                             popupSurface.height, 0, 0);
    }
...
void createPopup(LayerSurface& ls, int appIndex, int iconX, int iconY,
    ...
    popupSurface.xdgSurface =
        xdg_wm_base_get_xdg_surface(wl.xdgWmBase, popupSurface.surface);
    ...
    popupSurface.xdgPopup =
        xdg_surface_get_popup(popupSurface.xdgSurface, nullptr, positioner);
    xdg_popup_add_listener(popupSurface.xdgPopup, &xdg_popup_listener_impl,
                           nullptr);
